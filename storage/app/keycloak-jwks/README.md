...
[ERROR] mvn exec:java@jwks -Dexec.args="<keystore.jks> <alias> <algorithm> <keystore-password : Optional>"
[ERROR] Example:
[ERROR] mvn exec:java@jwks -Dexec.args="keystore-rsa.jks sample RS256 password"
```
